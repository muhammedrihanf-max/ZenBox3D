// Copyright 2017 Muhammed Rihan. All rights reserved.
...
const CREDITS_LINE1 string = "Open source game by Muhammed Rihan. Powered by g3n (github.com/g3n/engine)."
...
func main() {
	...
	// Create ZenBox 3D instance and initialize the G3N application
	g := new(Gokoban)
	g.Application = app.App(1280, 920, "ZenBox 3D")	
